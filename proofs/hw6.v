...
Gamma ⊢ snd t0 ∈ T2
  ...
  (* YOUR RULES GO HERE *)
  | TC_Pair : forall Gamma T1 T2 T3 t1 t2 C1 C2 C3,
      (Gamma ||- t1 \in T1 | C1) ->
      (Gamma ||- t2 \in T2 | C2) ->
      C3 = (T3 == (Ty_Prod T1 T2)) :: C1 ++ C2 ->
      (Gamma ||- <t1, t2> \in T3 | C3)
  | TC_Fst : forall Gamma T1 T2 T3 t C1 C2,
      (Gamma ||- t \in T1 | C1) ->
      C2 = (T1 == (Ty_Prod T2 T3)) :: C1 ->
      (Gamma ||- fst t \in T2 | C2)
  | TC_Snd : forall Gamma T1 T2 T3 t C1 C2,
      (Gamma ||- t \in T1 | C1) ->
      C2 = (T1 == (Ty_Prod T2 T3)) :: C1 ->
      (Gamma ||- snd t \in T3 | C2)
